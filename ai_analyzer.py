"""
Groq comparative reviewer for Nifty 500 Scanner v6.2.1.
...
def review_setups(
    ...
    for index, model in enumerate(models):
        ...
        attempts[-1]["error"] = (
            f"incomplete semantic review {len(reviews)}/{len(stocks)}: "
