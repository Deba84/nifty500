"""Official NIFTY 500 stock list (from NSE - 500 stocks)."""
...
NIFTY_500 = [
    ...
    ("ASTERDM", "Aster DM Quality Care Ltd.", "Healthcare"),
    ...
    ("JSWDULUX", "JSW Dulux Ltd.", "Consumer Durables"),
    ...
    ("LTM", "LTM Ltd.", "Information Technology"),
    ...
    ("LENSKART", "Lenskart Solutions Ltd.", "Consumer Services"),
    ...
    ("MEESHO", "Meesho Ltd.", "Consumer Services"),
    ...
    ("ONESOURCE", "Onesource Specialty Pharma Ltd.", "Healthcare"),
    ...
    ("PTCIL", "PTC Industries Ltd.", "Capital Goods"),
    ...
    ("PWL", "Physicswallah Ltd.", "Consumer Services"),
    ("PIDILITIND", "Pidilite Industries Ltd.", "Chemicals"),
    ("PINELABS", "Pine Labs Ltd.", "Financial Services"),
    ...
    ("PFOCUS", "Prime Focus Ltd.", "Media Entertainment & Publication"),
    ...
    ("RHIM", "RHI MAGNESITA INDIA LTD.", "Capital Goods"),
    ...
    ("SAMMAANCAP", "Sammaan Capital Ltd.", "Financial Services"),
    ...
    ("SARDAEN", "Sarda Energy and Minerals Ltd.", "Metals & Mining"),
    ...
    ("SIGNATURE", "Signatureglobal (India) Ltd.", "Realty"),
    ...
    ("SPLPETRO", "Supreme Petrochem Ltd.", "Chemicals"),
    ("SUZLON", "Suzlon Energy Ltd.", "Capital Goods"),
    ("SWANCORP", "Swan Corp Ltd.", "Chemicals"),
    ...
    ("TBOTEK", "TBO Tek Ltd.", "Consumer Services"),
    ...
    ("TTML", "Tata Teleservices (Maharashtra) Ltd.", "Telecommunication"),
    ("TECHM", "Tech Mahindra Ltd.", "Information Technology"),
    ("TECHNOE", "Techno Electric & Engineering Company Ltd.", "Construction"),
    ("TEGA", "Tega Industries Ltd.", "Capital Goods"),
    ("TEJASNET", "Tejas Networks Ltd.", "Telecommunication"),
    ("TENNIND", "Tenneco Clean Air India Ltd.", "Automobile and Auto Components"),
    ...
    ("TITAGARH", "Titagarh Rail Systems Ltd.", "Capital Goods"),
    ...
    ("TRAVELFOOD", "Travel Food Services Ltd.", "Consumer Services"),
    ...
    ("URBANCO", "Urban Company Ltd.", "Consumer Services"),
    ("USHAMART", "Usha Martin Ltd.", "Capital Goods"),
    ...
    ("ZFCVINDIA", "ZF Commercial Vehicle Control Systems India Ltd.", "Automobile and Auto Components"),
    ("ZEEL", "Zee Entertainment Enterprises Ltd.", "Media Entertainment & Publication"),
    ("ZENTEC", "Zen Technologies Ltd.", "Capital Goods"),
    ("ZENSARTECH", "Zensar Technolgies Ltd.", "Information Technology"),
